...
```bash
git add src/views/manual/reference.ts src/views/manual/ReferenceDocument.vue src/views/manual/BusinessRules.vue src/views/manual/DesignSystem.vue src/styles/pms-theme.css src/router/index.ts src/views/manual/manual.test.mjs
