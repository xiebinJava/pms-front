...
Define the values in `src/styles/design-system.ts` and mirror them in `src/styles/index.css`. Add focused rules in `src/styles/pms-theme.css` for stable hover/focus elevation, compact controls, and the responsive content gutter. Do not change any Vue template or API code in this task.
...
```bash
git add src/styles/design-system.ts src/styles/index.css src/styles/pms-theme.css src/styles/design-system.test.mjs docs/frontend-design-system.md docs/design-qa.md
...
```bash
git add src/layout/Index.vue src/layout/index.test.mjs src/styles/pms-theme.css src/locales/zh-CN.ts src/locales/en-US.ts
...
```bash
git add src/views/project/list/index.vue src/views/project/list/index.test.mjs src/styles/pms-theme.css docs/design-logic.md docs/design-qa.md
...
```bash
git add src/views/project/detail/index.vue src/views/project/detail/components/NodeNavigator.vue src/views/project/detail/components/TaskKanban.vue src/views/project/detail/components/Milestones.vue src/views/project/project-visual.test.mjs src/views/project/detail/workflow.test.mjs src/styles/pms-theme.css docs/design-logic.md docs/design-qa.md
...
```bash
git add src/views/admin/org/OrgCanvas.vue src/views/admin/org/index.vue src/views/admin/users/index.vue src/views/admin/roles/index.vue src/views/admin/import/index.vue src/views/admin/audit/index.vue src/views/feedback/index.vue src/views/manual/index.vue src/styles/pms-theme.css src/views/admin/admin-visual.test.mjs src/views/manual/manual.test.mjs docs/design-logic.md docs/design-qa.md
