...
const sections: ManualSection[] = [
  ...
  {
    id: 'requirements',
    titleKey: 'manual.sections.requirements.title',
    leadKey: 'manual.sections.requirements.lead',
    icon: BookOutlined,
    tagKeys: ['manual.sections.requirements.tags.analysis', 'manual.sections.requirements.tags.delivery'],
    relatedPath: '/development/requirements',
    media: [],
    purposeKey: 'manual.sections.requirements.purpose',
    stepsKey: 'manual.sections.requirements.steps',
    notesKey: 'manual.sections.requirements.notes',
    checklistKey: 'manual.sections.requirements.checklist',
    businessLogicKey: 'manual.sections.requirements.businessLogic',
    examplesKey: 'manual.sections.requirements.examples',
  },
  {
    id: 'projects',
  ...
  },
  {
    ...
    titleKey: 'manual.sections.workflowTemplates.title',
    leadKey: 'manual.sections.workflowTemplates.lead',
    icon: ApartmentOutlined,
    tagKeys: ['manual.sections.workflowTemplates.tags.processType', 'manual.sections.workflowTemplates.tags.versioning'],
    relatedPath: '/admin/workflows',
    media: [],
    purposeKey: 'manual.sections.workflowTemplates.purpose',
    stepsKey: 'manual.sections.workflowTemplates.steps',
    notesKey: 'manual.sections.workflowTemplates.notes',
    checklistKey: 'manual.sections.workflowTemplates.checklist',
    businessLogicKey: 'manual.sections.workflowTemplates.businessLogic',
    examplesKey: 'manual.sections.workflowTemplates.examples',
  },
  {
    id: 'audit',
