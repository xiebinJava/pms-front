  ...
  <div class="reference-document-page pms-page-stack">
    ...
    <div class="reference-document__layout">
      ...
      <main class="reference-document__content" :aria-label="t(referenceDocument.titleKey)">
        <section v-for="(section, index) in referenceDocument.sections" :id="section.id" :key="section.id" class="reference-document__section pms-panel" :aria-labelledby="`${section.id}-title`">
