...
const zhLocaleSource = fs.readFileSync(new URL('../../locales/zh-CN.ts', import.meta.url), 'utf8').replace(/\r\n/g, '\n')
const enLocaleSource = fs.readFileSync(new URL('../../locales/en-US.ts', import.meta.url), 'utf8').replace(/\r\n/g, '\n')
