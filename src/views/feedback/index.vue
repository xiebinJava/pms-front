...
import { createFeedback, getFeedback, listFeedback, listFeedbackAssignees, reopenFeedback, updateFeedback } from '/@/api/feedback'
import { getProjectPage } from '/@/api/project'
import { getNodes } from '/@/api/node'
import { getTasks } from '/@/api/task'
import { useUserStore } from '/@/store/user'
import { formatDateTime } from '/@/utils/format'
import type { FeedbackAssignee, FeedbackPriorityCode, FeedbackStatusCode, FeedbackTicket, FeedbackTypeCode, Project, ProjectNode, Task } from '/@/types/domain'
...
const personnelOptions = ref<FeedbackAssignee[]>([])
...
async function loadAuxiliaryData() {
  ...
  if (isManager.value) {
    try { personnelOptions.value = await listFeedbackAssignees() } catch { personnelOptions.value = [] }
  }
}
