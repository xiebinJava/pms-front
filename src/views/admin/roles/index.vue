...
const permissionOptions = computed(() => [
  ...
  { value: 'project:create', label: t('admin.roles.permProjectCreate') },
  { value: 'project:write', label: t('admin.roles.permProjectWrite') },
  { value: 'project:manage', label: t('admin.roles.permProjectManage') },
  { value: 'project:comment:write', label: t('admin.roles.permProjectComment') },
...
const selectedPermissions = computed({
  get: () => form.permissionCodes.filter(code => knownPermissionCodes.value.has(code)),
  set: (visible: string[]) => {
    const hidden = form.permissionCodes.filter(code => !knownPermissionCodes.value.has(code))
    form.permissionCodes = [...visible, ...hidden]
  },
})
