...
const permissionOptions = ['admin:user:read', 'admin:user:write', 'admin:org:read', 'admin:org:write', 'admin:role:read', 'admin:role:write', 'admin:import:write', 'admin:audit:read', 'project:read', 'project:write']
