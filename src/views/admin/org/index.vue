...
<template>
  <section class="admin-page pms-admin-page"><PmsPageHeader title="组织架构" description="以主归属管理树形架构，兼职与 PDT 通过人员归属表达。"><template #actions><a-button v-if="canWrite" class="pms-primary-button" @click="openCreate">+ 新增组织单元</a-button></template></PmsPageHeader>
